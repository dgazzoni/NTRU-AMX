...
if [ -d speed_results_${CPU}_dit ]
then
    # https://stackoverflow.com/a/226724/523079
    echo "Existing results will be deleted. Are you sure?"
    select yn in "Yes" "No"; do
        case $yn in
            Yes ) rm -rf speed_results_${CPU}_dit; break;;
            No ) exit;;
        esac
    done
fi

mkdir speed_results_${CPU}_dit
    ...
    do
        ...
        do
            ...
            do
                ...
                ./speed > /dev/null
                # Actual run
                ./speed > "../speed_results_${CPU}_dit/ntru:${PARAMETER_SET}:${ALLOC}:${IMPL}:${VARIANT}.txt"
                ...
                then
                    ...
                    # Actual run
                    ./speed \
                        > "../speed_results_${CPU}_dit/polymul:${PARAMETER_SET}:${ALLOC}:${IMPL}:${VARIANT}.txt"
...
do
    ...
    # Actual run
    ./speed > "../speed_results_${CPU}_dit/${MISC_TEST}.txt"
...
chown -R $(logname) build/ speed_results_${CPU}_dit/
