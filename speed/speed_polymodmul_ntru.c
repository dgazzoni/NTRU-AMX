...
int main() {
    ...
    WRAP_FUNC("amx_polymodmul 509 x 509: " CYCLE_TYPE "\n", cycles, time0, time1,
              amx_poly_mul_mod_65536_mod_x_d_minus_1_u16_32nx32n_coeffs(xy, x, y, 509, 16));
    WRAP_FUNC("amx_polymodmul 677 x 677: " CYCLE_TYPE "\n", cycles, time0, time1,
              amx_poly_mul_mod_65536_mod_x_d_minus_1_u16_32nx32n_coeffs(xy, x, y, 677, 22));
    WRAP_FUNC("amx_polymodmul 821 x 821: " CYCLE_TYPE "\n", cycles, time0, time1,
              amx_poly_mul_mod_65536_mod_x_d_minus_1_u16_32nx32n_coeffs(xy, x, y, 821, 26));
    WRAP_FUNC("amx_polymodmul 701 x 701: " CYCLE_TYPE "\n", cycles, time0, time1,
              amx_poly_mul_mod_65536_mod_x_d_minus_1_u16_32nx32n_coeffs(xy, x, y, 701, 22));
