...
class AMX_poly_mul_mod_x_d_minus_1_32nx32n_coeffs : public testing::TestWithParam<int> {};
...
TEST_P(AMX_poly_mul_mod_x_d_minus_1_32nx32n_coeffs, single) {
    uint16_t *x, *y, *xy, *xy2;
    int d = GetParam();
    int n = ((d + 31) / 32);
    ...
    amx_poly_mul_mod_65536_mod_x_d_minus_1_u16_32nx32n_coeffs(xy, x, y, d, n);
...
TEST_P(AMX_poly_mul_mod_x_d_minus_1_32nx32n_coeffs, initialize_to_zero) {
    uint16_t *x, *y, *xy, *xy2;
    int d = GetParam();
    int n = ((d + 31) / 32);
...
INSTANTIATE_TEST_SUITE_P(, AMX_poly_mul_mod_x_d_minus_1_32nx32n_coeffs, testing::Range(161, 822),
