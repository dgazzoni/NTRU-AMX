...
poly *f_kp, *g_kp, *G_kp, *invf_mod3_kp, *Gf_kp, *invGf_kp, *tmp_kp, *invh_kp, *h_kp;

__attribute__((constructor)) void alloc_kp(void) {
...
poly *h_enc, *liftm_enc, *ct_enc;

__attribute__((constructor)) void alloc_enc(void) {
...
poly *c_dec, *f_dec, *cf_dec, *mf_dec, *finv3_dec, *m_dec, *liftm_dec, *invh_dec, *r_dec, *b_dec;

__attribute__((constructor)) void alloc_dec(void) {
